...
import com.dkanen.rotationrumpus.collections.graphs.SceneGraph
import com.dkanen.rotationrumpus.collections.graphs.Vertex
...
import com.dkanen.rotationrumpus.game.actor.Label
import com.dkanen.rotationrumpus.game.actor.Line
import com.dkanen.rotationrumpus.game.actor.Square
import com.dkanen.rotationrumpus.game.ecs.components.behaviors.buttons.*
import com.dkanen.rotationrumpus.game.ecs.components.cameras.Camera
import com.dkanen.rotationrumpus.game.ecs.components.behaviors.Edge
...
import com.dkanen.rotationrumpus.game.ecs.components.input.Input
...
class BigObjectEntityManager(private val entityTable: EntityTable = EntityTable(EntityPool(size = 100))): EntityManager {
    ...
    override fun createAnimatedDecoration(slug: EntitySlug, position: Vector2, radius: Double, colorStroke: ColorRGBa, colorFill: ColorRGBa): Entity {
        ...
        entity.components += com.dkanen.rotationrumpus.game.ecs.components.animation.FollowLine(
            entity.slug,
            speed = 0.2,
